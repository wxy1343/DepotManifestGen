...
int __cdecl crc2(unsigned int *crc_clear, unsigned int *content_offset, int content_length)
{
	__asm(
		...
		movups (%edx),%xmm4;\
		push %esi;\
		movups 0x10(%edx),%xmm5;\
		movl (%eax),%esi;\
		movups 0x20(%edx),%xmm6;\
		push %edi;\
		movups 0x30(%edx),%xmm7;\
		add $0x40,%edx;\
		xor %edi,%edi;\
		movl $0x5B358FD3,%ecx;\
		test %esi,%esi;\
		...
		lea 0x40(%edx),%edx;\
		movaps %xmm4,%xmm1;\
		movups -0x40(%edx),%xmm0;\
		pclmulqdq $0x11,%xmm3,%xmm1;\
		pclmulqdq $0,%xmm3,%xmm4;\
		pxor %xmm1,%xmm4;\
		movaps %xmm5,%xmm1;\
		pxor %xmm0,%xmm4;\
		movups -0x30(%edx),%xmm0;\
		pclmulqdq $0x11,%xmm3,%xmm1;\
		pclmulqdq $0,%xmm3,%xmm5;\
		pxor %xmm1,%xmm5;\
		movaps %xmm6,%xmm1;\
		pxor %xmm0,%xmm5;\
		movups -0x20(%edx),%xmm0;\
		pclmulqdq $0x11,%xmm3,%xmm1;\
		pclmulqdq $0,%xmm3,%xmm6;\
		pxor %xmm1,%xmm6;\
		movaps %xmm2,%xmm1;\
		pxor %xmm0,%xmm6;\
		movups -0x10(%edx),%xmm0;\
		...
		xor %eax,%eax;\
		xor %edi,%edi;\
		movups %xmm4,-0x40(%ebp);\
		movups %xmm5,-0x30(%ebp);\
		movups %xmm6,-0x20(%ebp);\
		movups %xmm2,-0x10(%ebp);\
		lea (%ecx),%ecx;\
		e:;\
		xor -0x40(%ebp,%edi,4),%eax;\
		inc %edi;\
		movzx %al,%ecx;\
		shr $8,%eax;\
		movl _b(,%ecx,4),%esi;\
...
unsigned int __cdecl crc1(unsigned int *a1, unsigned char *a2, int a3, int a4)
{
	__asm(
		...
		movzx %al,%ecx;\
		shr $8,%eax;\
		mov 0xC00(%edi,%ecx,4),%edx;\
		movzx %al,%ecx;\
		shr $8,%eax;\
		xor 0x800(%edi,%ecx,4),%edx;\
		movzx %al,%ecx;\
		shr $8,%eax;\
		mov 0x400(%edi,%ecx,4),%ebx;\
		xor (%edi,%eax,4),%ebx;\
		mov 0xC(%ebp),%eax;\
		xor 4(%esi,%eax),%ebx;\
		xor %edx,%ebx;\
		movzx %bl,%eax;\
		shr $8,%ebx;\
		mov 0xC00(%edi,%eax,4),%ecx;\
		movzx %bl,%eax;\
		shr $8,%ebx;\
		xor 0x800(%edi,%eax,4),%ecx;\
		movzx %bl,%eax;\
		shr $8,%ebx;\
		mov 0x400(%edi,%eax,4),%eax;\
		xor (%edi,%ebx,4),%eax;\
		mov 0xC(%ebp),%ebx;\
		xor %ecx,%eax;\
		add $8,%esi;\
